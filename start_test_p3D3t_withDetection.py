...
# MODEL TO BE LOADED
# =============================================================================
path_model = root / 'SavedModels/train_pseudo3D_overlap64_augmented_4perc_lessCpOnly_6blocks_128filter_8batch_1e-05lrScheduledTrue_19epochs_leakybatchdiceCe_train1.pt'
# Channels
in_c = 6
out_c = 2
# Network depth
...
# DATASET
# =============================================================================
input_name_test = 'test_pseudo3D3t_overlap64_augmented'
...
for img,target in zip(images,targets): 
    ...
    for cp in target_cps:
        if cp in pred_cps:
            cp_sample = [tstep,patch,simulation,"p3D3t",target_cps_count[l],True]
            cps_list.append(cp_sample)
        else:
            cp_sample = [tstep,patch,simulation,"p3D3t",target_cps_count[l],False]
            cps_list.append(cp_sample)            
        l += 1
    ...
    detection_sample = [tstep,patch,simulation,"p3D3t",total_cps,detected_cps,false_cps]
