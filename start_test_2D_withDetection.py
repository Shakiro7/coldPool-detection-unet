...
# DATASET
# =============================================================================
input_name_test = 'test_2D_overlap64_augmented'
...
for img,target in zip(images,targets): 
    ...
    for cp in target_cps:
        if cp in pred_cps:
            cp_sample = [tstep,patch,simulation,"2D",target_cps_count[l],True]
            cps_list.append(cp_sample)
        else:
            cp_sample = [tstep,patch,simulation,"2D",target_cps_count[l],False]
            cps_list.append(cp_sample)            
        l += 1
